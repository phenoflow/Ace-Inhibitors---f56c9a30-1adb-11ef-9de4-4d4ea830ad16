...
codes = [{"code":"39147","system":"gprdproduct"},{"code":"9764","system":"gprdproduct"},{"code":"1021","system":"gprdproduct"},{"code":"17655","system":"gprdproduct"},{"code":"39242","system":"gprdproduct"}];
REQUIRED_CODES = 1;
